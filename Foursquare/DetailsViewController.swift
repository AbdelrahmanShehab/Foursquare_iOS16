...
class DetailsViewController: UIViewController, MKMapViewDelegate {
                    ...
                    if objects!.count > 0 {
                        ...
                        if let placeLatitude = chosenPlaceObject.object(forKey: "latitude") as? String {
                            if let placeLatitudeDouble = Double(placeLatitude) {
                                self.chosenLatitide = placeLatitudeDouble
                            }
                        }
                        ...
                        // MAP
                        let location = CLLocationCoordinate2D(latitude: self.chosenLatitide, longitude: self.chosenLongitude)
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        if self.chosenLongitude != 0.0 && self.chosenLatitide != 0.0 {
            let requestLocation = CLLocation(latitude: self.chosenLongitude, longitude: self.chosenLongitude)
